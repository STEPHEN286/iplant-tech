    ...
    <section id="testimonials" className="py-16 md:py-20 bg-[#f8f9f2]">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
              {[
                {
                  quote: "iPlantTech has completely transformed my farm. My crops have never looked healthier!",
                  name: "Sarah Johnson",
                  title: "Organic Farmer",
                },
                {
                  quote: "As a commercial grower, I rely on iPlantTech to monitor multiple fields efficiently.",
                  name: "Michael Chen",
