                  ...
                  <Card className="border-0">
                    <CardContent className="p-6 flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <a href="tel:+233500242059" className="text-gray-600 hover:text-green-600 transition-colors">
                          +233 50 024 2059
                        </a>
                      </div>
                    </CardContent>
                  ...
                  <Card className="border-0">
                    <CardContent className="p-6 flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <a href="mailto:iplanttech.ai@gmail.com" className="text-gray-600 hover:text-green-600 transition-colors">
                          iplanttech.ai@gmail.com
                        </a>
                      </div>
                    </CardContent>
                  </Card>
